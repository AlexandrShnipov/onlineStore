    ...
    return (
      <MainContainer>
        <div className={s.container}>
          ...
          <div className={s.productParametrs}>
            <h2 className={s.productParametrsTitle}>Apollo
              <span>Running Short</span>
            </h2>
            <div className={`${s.productParametrsItem} ${s.productParametrsSize}`}>
              <h3>Size:</h3>
              <div className={s.productParametrsSizeOptions}>
            ...
            <div className={`${s.productParametrsItem} ${s.productParametrsColor}`}>
              <h3>Color:</h3>
              <div className={s.productParametrsColorOptions}>
            ...
            <div className={`${s.productParametrsItem} ${s.productParametrsPrice}`}>
              <h3>Price:</h3>
              <span>$50.00</span>
            </div>
            <button className={s.productParametrsButtonToCart}>add to cart</button>
            <p className={s.productParametrsDescription}>
